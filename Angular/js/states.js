            ...
            resolve: {
                repositorio: function(){
                    ...
                    return [
                        ...
                        new PuntoDeInteres("4","Banco ICBC", "(-34.703915, -58.391966)", "Av. Hipólito Yrigoyen 4227", "Sucursal de banco", { serviciosAsociados: {"Evaluacion para un credito" : "Chequeras"} , zona: "Lanus" } ),
              ...
              resolve: {
                repositorio: function(){
                    ...
                    return [
                        ...
                        new PuntoDeInteres("4","Banco ICBC", "(-34.703915, -58.391966)", "Av. Hipólito Yrigoyen 4227", "sucursalBanco", { serviciosAsociados: {"Evaluacion para un credito" : "Chequeras"} , zona: "Lanus" } ),
